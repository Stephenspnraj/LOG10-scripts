...
def process_beta_tptr(trip_code):
    ...
    if tptr_requests:
        for request_row in tptr_requests:
            ...
            # Modify trip_destination_hub to connection_destination
            if 'connection_destination' in request_json:
                request_json['trip_destination_hub'] = request_json['connection_destination']
